package com.rxandroid.xing.rxproject.net.interceptor;
 ...
 */
public class DuiaLogInterceptor implements Interceptor {
    ...
    public DuiaLogInterceptor() {
        this(Logger.DEFAULT);
    }

    public DuiaLogInterceptor(Logger logger) {
        this.logger = logger;
    }

    /** Change the level at which this interceptor logs. */
    public DuiaLogInterceptor setLevel(Level level) {
